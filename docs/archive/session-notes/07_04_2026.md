# Themis — Archived TODO (2026-04-07)

> Archived from todo.md. Covers work from differential testing, VITAL cascade fix, dom1 multi-core boot, code review cleanup, and all prior completed phases.
...
- [x] Testing: differential testing vs Rust engine — all 21 categories passing (see below)
...
## Done: lean-exec differential testing (21/21 passing)
...
## BUG (FIXED): VITAL memory revocation does not cascade domain cleanup

**Severity**: High — causes permanent memory range loss.
**Fix**: commit 5830fdacf
...
## TODO (DONE): Implement VITAL cascade in Lean + revert workarounds
