...
Fix the CLI and the capa-engine capabilities implementation accordingly.
...
If you go back to the pdf paper in capa-engine/ folder, we say that these information should appear in the attestation (and also in the output of the list command).
